    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('discussion', 'Обсуждение'), ('development', 'Проработка'), ('in_progress', 'В процессе'), ('review', 'Проверка'), ('awaiting_payment', 'Ожидание оплаты'), ('paid', 'Оплачено'), ('frozen', 'Заморожено')], default='discussion', max_length=50, verbose_name='Статус')),
